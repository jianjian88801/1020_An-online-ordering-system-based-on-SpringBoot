<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="会员折扣" prop="huiyuanzhekou">
          <el-input v-model="ruleForm.huiyuanzhekou" 
              placeholder="会员折扣" clearable  :readonly="ro.huiyuanzhekou"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="会员折扣" prop="huiyuanzhekou">
              <el-input v-model="ruleForm.huiyuanzhekou" 
                placeholder="会员折扣" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
