  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255,255,255,.5);borderRadius:10px">
        <h1 class="h1" style="color:rgba(252, 252, 252, 1);fontSize:30px;">网上订餐系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="地址" class="input" v-if="tableName=='huiyuan'">
			  <el-input v-model="ruleForm.dizhi" autocomplete="off" placeholder="地址" type="text" />
			</el-form-item>
			<!-- <div v-if="tableName=='huiyuan'" class="input-group">
			   <div class="label">会员等级</div>
			   <div class="input-container">
			     <input v-model="ruleForm.huiyuandengji" class="input" type="text" placeholder="会员等级">
			   </div>
			 </div> -->
			<el-form-item label="会员等级" class="input" v-if="tableName=='huiyuan'">
			  <el-input v-model="ruleForm.huiyuandengji" autocomplete="off" placeholder="会员等级" type="text" />
			</el-form-item>
			<!-- <div v-if="tableName=='huiyuan'" class="input-group">
			   <div class="label">会员折扣</div>
			   <div class="input-container">
			     <input v-model="ruleForm.huiyuanzhekou" class="input" type="text" placeholder="会员折扣">
			   </div>
			 </div> -->
			<el-form-item label="会员折扣" class="input" v-if="tableName=='huiyuan'">
			  <el-input v-model="ruleForm.huiyuanzhekou" autocomplete="off" placeholder="会员折扣" type="text" />
			</el-form-item>
...
<style lang="scss" scoped>
 ...
 //  }
	...
	.container {
		background-image: url("http://codegen.caihongy.cn/20210323/8b220cd6ea964dd584108c4aea44a7a9.jpg");
		height: 100vh;
