<template>
  <el-breadcrumb class="app-breadcrumb" separator="ღღღ" style="height:50px;backgroundColor:rgba(221, 213, 213, 1);borderRadius:4px;padding:0px 20px 0px 20px;boxShadow:;borderWidth:0px;borderStyle:double ;borderColor:rgba(3, 35, 35, 1);">
