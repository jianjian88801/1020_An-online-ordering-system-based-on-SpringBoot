	...
	export default {
		data() {
			return {
				...
				ruleForm: {},
				user: {},
				heads: {"headLogoutFontHoverColor":"rgba(11, 7, 249, 1)","headFontSize":"20px","headUserInfoFontColor":"rgba(23, 22, 22, 1)","headBoxShadow":"0 2px 5px #888","headTitleImgHeight":"44px","headFontColor":"rgba(65, 69, 69, 0.77)","headTitleImg":false,"headHeight":"50px","headTitleImgBorderRadius":"22px","headTitleImgUrl":"http://codegen.caihongy.cn/20201021/cc7d45d9c8164b58b18351764eba9be1.jpg","headBgColor":"#DDD5D5","headTitleImgBoxShadow":"0 1px 6px #444","headLogoutFontColor":"rgba(20, 19, 19, 1)","headUserInfoFontSize":"16px","headTitleImgWidth":"44px","headTitleStyle":"2","headLogoutFontSize":"16px"},
			};
		},
		created() {
			this.setHeaderStyle()
